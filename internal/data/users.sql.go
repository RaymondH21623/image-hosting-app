...
VALUES ($1, $2, $3, $4)
RETURNING id, public_id, username, email, password_hash, created_at, activated, version
`
...
SELECT id, public_id, username, email, password_hash, created_at, activated, version FROM users WHERE email = $1 LIMIT 1
`
